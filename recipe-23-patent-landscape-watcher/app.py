...
import agent
from lib.config import DIGEST_TO, PATENT_QUERY

app = FastAPI(title="Patent Landscape Watcher")
...
def health() -> dict[str, str]:
    return {
        "ok": "true",
        "slug": "recipe-23-patent-landscape-watcher",
...
def index() -> HTMLResponse:
    return HTMLResponse(
        landing_page(
            ...
            endpoints=[
        ("POST", "/run?dry_run=1", "Run landscape watcher.")
            ],
